...
git remote set-url origin https://github.com/sakib-rahman-bangladesh/generic-dashboard
############
# Step: 07 #
############
...
git push --all -f https://github.com/sakib-rahman-bangladesh/generic-dashboard